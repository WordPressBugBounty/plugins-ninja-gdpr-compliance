        ...
        public function add_notification() {
            ...
            <div class="notice notice-info is-dismissible" id="njt-ads-wrapper">
                <div class="njt-d-row njt-justify-between">
                    ...
                    <img class="njt-ads-img" src="<?php echo NJT_GDPR_URL . '/assets/img/FB_Wireframe.png' ?>" alt="filebird">
                </div>
            </div>
            <style>
...
if ( !class_exists('FileBirdCross') ) {
    ...
    FileBirdCross::get_instance('filebird', 'filebird+ninjateam', NJT_GDPR_URL, array('filebird/filebird.php', 'filebird-pro/filebird.php'));
}
