...
class NjtGdpr
{
    ...
    private function getPopupHtml($settings)
    {
        ...
        $accept_btn .= '<img src="' . NJT_GDPR_URL . '/assets/home/img/loader.svg" class="njt-gdpr-loading-icon" alt="'. __( 'Loading', NJT_GDPR_I18N ) .'" />';
        $accept_btn .= '</div>';
        //add decline btn
        $decline_btn = '';
        if ($settings['is_enable_decline_btn']) {
            ...
            $decline_btn .= '<img src="' . NJT_GDPR_URL . '/assets/home/img/loader.svg" class="njt-gdpr-loading-icon" alt="'. __( 'Loading', NJT_GDPR_I18N ) .'" />';
            $decline_btn .= '</div>';
        }
    ...
    {
        global $post;
        if (isset($this->hook_suffix['cookie_popup']) && $hook_suffix == $this->hook_suffix['cookie_popup']) {
